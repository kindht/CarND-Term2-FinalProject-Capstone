...
class Controller(object):
    def __init__(self, vehicle_mass, fuel_capacity, brake_deadband, decel_limit, accel_limit, 
        ...
        mx = 0.3   # maximum throttle value 0.2
        self.throttle_controller = PID(kp, ki, kd, mn, mx)

        tau = 0.5  # cutoff frequncey  1/(2pi*tau)
        ts  = 0.02 # sample time
    ...
    def control(self, dbw_enabled, current_vel, linear_vel, angular_vel):
        ...
        if linear_vel == 0. and current_vel < 0.1:
            throttle = 0
            brake = 700  # N*m , 400 for simulator, 700 for Carla - to hold the car in place if vehicle stopped at a light 
